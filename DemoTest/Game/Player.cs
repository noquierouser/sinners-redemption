...
namespace DemoTest
{
    class Player
    {
        ...
        public void LoadContent()
        {
            ...
            sprite = Level.Content.Load<Texture2D>("Idle");
        ...
        public void Draw(GameTime gameTime, SpriteBatch spriteBatch)
        {
            ...
            Rectangle source = new Rectangle(0, 0, sprite.Height, sprite.Height);
            spriteBatch.Draw(sprite, position, source, Color.White, 0.0f, Origin, 1.0f, SpriteEffects.None, 0.0f);
        }
    }
}